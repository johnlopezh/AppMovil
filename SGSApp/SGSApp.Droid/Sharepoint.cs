...
namespace SGSApp.Droid
{
    ...
    {
        [JsonProperty("__deferred")] public Deferred Deferred { get; set; }
    }
    ...
    {
        [JsonProperty("__deferred")] public Deferred2 Deferred { get; set; }
    }
    ...
    {
        [JsonProperty("__deferred")] public Deferred3 Deferred { get; set; }
    }
    ...
    {
        [JsonProperty("__deferred")] public Deferred4 Deferred { get; set; }
    }
    ...
    {
        [JsonProperty("__deferred")] public Deferred5 Deferred { get; set; }
    }
    ...
    {
        [JsonProperty("__deferred")] public Deferred7 Deferred { get; set; }
    }
    ...
    {
        [JsonProperty("__deferred")] public Deferred8 Deferred { get; set; }
    }
    ...
    public class File
    {
        [JsonProperty("__deferred")] public Deferred9 Deferred { get; set; }
    }
    ...
    public class Folder
    {
        [JsonProperty("__deferred")] public Deferred10 Deferred { get; set; }
    }
    ...
    {
        [JsonProperty("__deferred")] public Deferred11 Deferred { get; set; }
    }
    ...
    {
        [JsonProperty("__metadata")] public Metadata2 Metadata { get; set; }

        [JsonProperty("results")] public object[] Results { get; set; }
    }
    ...
    public class ListItem
    {
        ...
        [JsonProperty("RoleAssignments")] public RoleAssignments RoleAssignments { get; set; }

        [JsonProperty("AttachmentFiles")] public AttachmentFiles AttachmentFiles { get; set; }

        [JsonProperty("ContentType")] public ContentType ContentType { get; set; }

        [JsonProperty("GetDlpPolicyTip")] public GetDlpPolicyTip GetDlpPolicyTip { get; set; }

        [JsonProperty("FieldValuesAsHtml")] public FieldValuesAsHtml FieldValuesAsHtml { get; set; }

        [JsonProperty("FieldValuesAsText")] public FieldValuesAsText FieldValuesAsText { get; set; }

        [JsonProperty("FieldValuesForEdit")] public FieldValuesForEdit FieldValuesForEdit { get; set; }

        [JsonProperty("File")] public File File { get; set; }

        [JsonProperty("Folder")] public Folder Folder { get; set; }

        [JsonProperty("ParentList")] public ParentList ParentList { get; set; }
        ...
        [JsonProperty("PredecessorsId")] public PredecessorsId PredecessorsId { get; set; }
