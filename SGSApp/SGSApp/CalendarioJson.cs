...
namespace SGSApp
{
    ...
    public class ListItemEventsCalendario
    {
        [JsonProperty("__metadata")] public Metadata Metadata { get; set; }

        [JsonProperty("Image")] public Metadata Image { get; set; }
    ...
    public class C
    {
        [JsonProperty("results")] public ListItemEventsCalendario[] Results { get; set; }
    }

    public class ListEventsCalendar
    {
        [JsonProperty("d")] public C C { get; set; }
    }
}